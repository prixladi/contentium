...
export default function App() {
  ...
  return (
    <div>
      <input value={color} onChange={(e) => setColor(e.target.value)} />
      <p style={{ color }}>Hello, world!  world! world! world! world! world! world! world! world! world! world! world! world! world! world! world!</p>
      <ExpensiveTreeExpensiveTreeExpensiveTreeExpensiveTreeExpensiveTreeExpensiveTreeExpensiveTreeExpensiveTreeExpensiveTree />
    </div>
  );
}
```
